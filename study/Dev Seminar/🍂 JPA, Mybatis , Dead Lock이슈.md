...
3. *3번함수*는 커넥션풀이 <u>해제되길 무한정 기다림.</u>

---

# <font color="#9bbb59">해결방법</font>
...
## 3. JPA 또는 mybatis 단일화
- JAP로 함수를 단일화 한다면, **동일한 커넥션(HikariCP) 안에서 실행**되어, 커넥션 풀 무한 대기/선점 문제를 방지할 수 있다.
- 또는 mybatis로 단일화 하더라도, 처리 **즉시 커넥션풀을 반환**하기 때문에 문제해결 가능
